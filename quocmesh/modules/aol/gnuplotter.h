...
class Plotter {
protected:
  char _noutput[1024], _plotfile[1024], _title[1024], _special[1024], _grid[1024], _size[1024], _xlabel[1024], _ylabel[1024], _xtics[1024], _ytics[1024], _border[1024], _plotcommand[1024], _outputDir[1024], _terminal[1024];
